  ...
  $.simpleWeather({
    ...
    unit: 'c',
      success: function(weather) {
          ...
          html += '<img style="float:left;" width="125px" height="80px" src="'+weather.image+'">';
